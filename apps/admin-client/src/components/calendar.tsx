...
function Calendar({
  ...
  const [navView, setNavView] = useState<NavView>(NavView.Days);
  ...
  const columnsDisplayed = navView === NavView.Years ? 1 : numberOfMonths;
      ...
      components={{
        ...
        CaptionLabel: ({ children }) => (
          <Button
            ...
            onClick={() =>
              setNavView((prev) =>
                prev === NavView.Days ? NavView.Years : NavView.Days,
              )
            }
          >
            {navView === NavView.Days
              ? children
                  ...
                  (_, i) => {
                    ...
                    return (
                      <Button
                        ...
                        disabled={
                          navView === NavView.Years ? isDisabled : undefined
                        }
                      >
                        {displayYears.from + i}
                      </Button>
